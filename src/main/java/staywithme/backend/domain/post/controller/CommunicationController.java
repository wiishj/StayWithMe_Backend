...
public class CommunicationController {
    ...
    public ResponseEntity<?> getCommunicationByCategory(@Parameter(description = "조회할 모임의 카테고리 (NOTIFICATION, QUESTION, FREE, SHARING 중 하나)") @RequestParam("category") String category){
